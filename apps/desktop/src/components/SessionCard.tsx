    ...
    >
      <div className="session-card-header">
        <div>
          ...
          <div className="session-card-meta-row">
            <span className="meta-chip"><GitBranch size={14} /> {session.branch ?? 'No branch'}</span>
      ...
      <div className="session-card-footer">
        <div className="action-row">
          <button type="button" className="icon-button" onClick={(event) => { event.stopPropagation(); actions.onOpenTerminal(session); }}><SquareTerminal size={16} /></button>
