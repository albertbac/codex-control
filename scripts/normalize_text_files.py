...
repository = "[https://github.com/albertbac/codex-control](https://github.com/albertbac/codex-control)"
""")

biome_json = {
"$schema": "[https://biomejs.dev/schemas/2.0.5/schema.json](https://biomejs.dev/schemas/2.0.5/schema.json)",
"formatter": {
"enabled": True,
"indentStyle": "space",
"indentWidth": 2,
